        ...
        <div className="relative w-full max-w-xl z-10">
          <div className="mb-8">
            ...
            <p className="text-base text-slate-600 max-w-md leading-relaxed min-h-[3rem]">
              Access real-time analytics, manage your curriculum, and personalize learning paths for every student with AI-driven insights.
            </p>
          </div>
          <div className="relative mt-6">
            ...
            <div className="absolute -right-6 top-8 glass-panel p-4 rounded-2xl w-40 animate-float">
              ...
              <p className="text-[10px] text-slate-400 mt-1">Class performance</p>
            </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 lg:px-10 bg-white relative overflow-y-auto">
        <div className="w-full max-w-[360px] py-4">
          ...
          <div className="mb-4 text-center lg:text-left min-h-[3.5rem]">
            <h2 className="text-lg font-display font-bold text-slate-900 mb-1">Welcome back, Educator</h2>
            <p className="text-xs text-slate-500">Sign in to manage your classes and view insights.</p>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-3">
            <div className="space-y-1">
              <label className="block text-xs font-semibold text-slate-700" htmlFor="email">School Email</label>
              <input
